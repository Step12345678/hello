...
with streamlit_analytics.track():
    ...
    st.write('''The computer (on the right) randomly selects a team and you will select your team (on the left). You need to create a team that will score more points that the computers randomly generated team.''') 
    st.write('''In order to start a new game, reload the page and a new team will be generated by the computer''')
    df2 = load_data()
